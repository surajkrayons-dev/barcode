        ...
        <form action="{{ Route::has('registration.store') ? route('registration.store') : '#' }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <select name="title" required class="w-full border {{ $errors->has('title') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
            ...
            <div class="mb-6">
                ...
                <select name="gender" required class="w-full border {{ $errors->has('gender') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
            ...
            <div class="mb-6">
                ...
                <select name="job_title" required class="w-full border {{ $errors->has('job_title') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
                    <option value="">Select an option</option>
                    <option value="owner" {{ old('job_title') == 'owner' ? 'selected' : '' }}>Owner / Proprietor</option>
                    <option value="director" {{ old('job_title') == 'director' ? 'selected' : '' }}>Director</option>
            ...
            <div class="mb-8">
                ...
                <select name="job_function" required class="w-full border {{ $errors->has('job_function') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
                    <option value="">Select an option</option>
                    <option value="purchase" {{ old('job_function') == 'purchase' ? 'selected' : '' }}>Purchase / Sourcing</option>
                    <option value="sales" {{ old('job_function') == 'sales' ? 'selected' : '' }}>Sales / Marketing</option>
                    <option value="operations" {{ old('job_function') == 'operations' ? 'selected' : '' }}>Operations</option>
                    <option value="other" {{ old('job_function') == 'other' ? 'selected' : '' }}>Other</option>
                </select>
                @error('job_function') <p class="text-red-600 text-sm mt-1">⚠ {{ $message }}</p> @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <select name="country" required class="w-full border {{ $errors->has('country') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
                    <option value="">Select an option</option>
            ...
            <div class="mb-6">
                ...
                @error('pincode') <p class="text-red-600 text-sm mt-1">⚠ {{ $message }}</p> @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <select name="state" required class="w-full border {{ $errors->has('state') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
                    <option value="">Select an option</option>
                    @foreach([
            ...
            <div class="mb-6">
                ...
                <select name="industry_segment" required class="w-full border {{ $errors->has('industry_segment') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
                    <option value="">Select an option</option>
                    <option value="retail" {{ old('industry_segment') == 'retail' ? 'selected' : '' }}>Retail</option>
                    <option value="wholesale" {{ old('industry_segment') == 'wholesale' ? 'selected' : '' }}>Wholesale / Distribution</option>
                    <option value="manufacturing" {{ old('industry_segment') == 'manufacturing' ? 'selected' : '' }}>Manufacturing</option>
                    <option value="other" {{ old('industry_segment') == 'other' ? 'selected' : '' }}>Other</option>
                </select>
                @error('industry_segment') <p class="text-red-600 text-sm mt-1">⚠ {{ $message }}</p> @enderror
            </div>

            <div class="mb-6">
                <label class="block font-semibold text-gray-800 mb-2">Primary nature of business <span class="text-red-500">*</span></label>
                <select name="business_nature" required class="w-full border {{ $errors->has('business_nature') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
                    <option value="">Select an option</option>
                    <option value="importer" {{ old('business_nature') == 'importer' ? 'selected' : '' }}>Importer</option>
                    <option value="exporter" {{ old('business_nature') == 'exporter' ? 'selected' : '' }}>Exporter</option>
                    <option value="trader" {{ old('business_nature') == 'trader' ? 'selected' : '' }}>Trader</option>
                    <option value="other" {{ old('business_nature') == 'other' ? 'selected' : '' }}>Other</option>
                </select>
                @error('business_nature') <p class="text-red-600 text-sm mt-1">⚠ {{ $message }}</p> @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <select name="primary_product_group" required class="w-full border {{ $errors->has('primary_product_group') ? 'border-red-500 ring-1 ring-red-400' : 'border-gray-200' }} bg-gray-50 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-400">
                    <option value="">Select an option</option>
                    <option value="gifts" {{ old('primary_product_group') == 'gifts' ? 'selected' : '' }}>Gifts & Novelty</option>
                    <option value="stationery" {{ old('primary_product_group') == 'stationery' ? 'selected' : '' }}>Stationery & Paper</option>
                    <option value="houseware" {{ old('primary_product_group') == 'houseware' ? 'selected' : '' }}>Houseware</option>
                    <option value="other" {{ old('primary_product_group') == 'other' ? 'selected' : '' }}>Other</option>
                </select>
                @error('primary_product_group') <p class="text-red-600 text-sm mt-1">⚠ {{ $message }}</p> @enderror
            </div>
            ...
            <div class="mb-8">
                ...
                <select name="additional_product_group" required
                    ...
                    <option value="gifts" {{ old('additional_product_group') == 'gifts' ? 'selected' : '' }}>Gifts & Novelty</option>
                    <option value="stationery" {{ old('additional_product_group') == 'stationery' ? 'selected' : '' }}>Stationery & Paper</option>
                    <option value="houseware" {{ old('additional_product_group') == 'houseware' ? 'selected' : '' }}>Houseware</option>
                    <option value="toys" {{ old('additional_product_group') == 'toys' ? 'selected' : '' }}>Toys</option>
                    <option value="other" {{ old('additional_product_group') == 'other' ? 'selected' : '' }}>Other</option>
                </select>
                @error('additional_product_group') <p class="text-red-600 text-sm mt-1">⚠ {{ $message }}</p> @enderror
            </div>
            ...
            @error('terms') <p class="text-red-600 text-sm -mt-4 mb-4">⚠ {{ $message }}</p> @enderror

            <div class="mb-8 flex items-start gap-3">
                <input type="checkbox" name="agree_children_policy" id="agree_children_policy" required {{ old('agree_children_policy') ? 'checked' : '' }}
                    class="mt-1 h-5 w-5 border-gray-300 rounded text-red-600 focus:ring-red-400">
            ...
            @error('agree_children_policy') <p class="text-red-600 text-sm -mt-4 mb-4">⚠ {{ $message }}</p> @enderror
            ...
            <p class="text-center text-gray-600 mt-4">
                Already registered? <a href="{{ Route::has('registrations.find') ? route('registrations.find') : '#' }}" class="text-blue-600 font-semibold underline">Find your badge</a>
            </p>
